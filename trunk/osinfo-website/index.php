...
?>
	<div class="text">
		...
		<p class="medium">Where it is possible it only uses standard *nix/POSIX tools. Dome information is unavailable (but quite common) packages, but the availability of these are tested, and no error messaged are produced if these rarer tools are missing.</p>
	</div>
	<hr class="hide" />
	<div class="center">
		<p>
